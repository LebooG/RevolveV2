...
export default function LeaseScreen({ navigation }: any) {
  return (
    <SafeAreaView style={s.c}>
      <View style={s.h}>
        <TouchableOpacity onPress={() => navigation.goBack()}><Ionicons name="arrow-back" size={22} color={Colors.gray900} /></TouchableOpacity>
        <Text style={s.t}>Lease Agreements</Text>
        <View style={{ width: 22 }} />
      </View>
      <View style={s.b}><Text style={s.p}>Lease management — upload, view, and digitally sign lease agreements</Text></View>
    </SafeAreaView>
  );
}
